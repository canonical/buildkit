...
# TODO: this one is quite old, but is planned to be resumed
...
RUN xx-apt install -y shadow shadow-uidmap sudo vim iptables ip6tables dnsmasq fuse curl \
...
ARG AZURITE_VERSION
RUN xx-apt install -y nodejs npm \
